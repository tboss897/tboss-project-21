...
var ponyfill = require('barcode-detector/ponyfill');
...
const HAS_NATIVE_BARCODE_DETECTOR = typeof window !== 'undefined' && 'BarcodeDetector' in window;
...
function useCamera(options = {}) {
    ...
    const taskQueue = react.useRef(Promise.resolve({ type: 'stop', data: {} }));
    const currentStream = react.useRef(null);
    const currentVideoTrack = react.useRef(null);
    const [capabilities, setCapabilities] = react.useState({});
    const [settings, setSettings] = react.useState({});
    const runStartTask = react.useCallback(async (videoEl, constraints) => {
    ...
    const runStopTask = react.useCallback(async (videoEl, stream) => {
    ...
    const startCamera = react.useCallback(async (videoEl, { constraints, restart = false }) => {
        let startError = null;
    ...
    const updateConstraints = react.useCallback(async (newConstraints) => {
...
function useScanner(props) {
    ...
    const formatsKey = react.useMemo(() => [...formats].sort().join('|'), [formats]);
    ...
    if (typeof window !== 'undefined' && barcodeDetectorRef.current === null) {
        barcodeDetectorRef.current = new ponyfill.BarcodeDetector({ formats });
    }
    ...
    const processFrame = react.useCallback((state) => async (timeNow) => {
        ...
        const newContentBefore = anyNewCodesDetected
            ? new Set(detectedCodes.map((code) => code.rawValue))
            : contentBefore;
        const newState = {
            lastScan: timeNow,
            lastOnScan,
...
function CameraOnIcon(props) {
    ...
    return (jsxRuntime.jsxs("svg", { "aria-hidden": "true", focusable: "false", className: className, style: mergedStyle, width: "28px", height: "28px", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: [jsxRuntime.jsx("path", { d: "M12 16C13.6569 16 15 14.6569 15 13C15 11.3431 13.6569 10 12 10C10.3431 10 9 11.3431 9 13C9 14.6569 10.3431 16 12 16Z" }), jsxRuntime.jsx("path", { d: "M3 16.8V9.2C3 8.0799 3 7.51984 3.21799 7.09202C3.40973 6.71569 3.71569 6.40973 4.09202 6.21799C4.51984 6 5.0799 6 6.2 6H7.25464C7.37758 6 7.43905 6 7.49576 5.9935C7.79166 5.95961 8.05705 5.79559 8.21969 5.54609C8.25086 5.49827 8.27836 5.44328 8.33333 5.33333C8.44329 5.11342 8.49827 5.00346 8.56062 4.90782C8.8859 4.40882 9.41668 4.08078 10.0085 4.01299C10.1219 4 10.2448 4 10.4907 4H13.5093C13.7552 4 13.8781 4 13.9915 4.01299C14.5833 4.08078 15.1141 4.40882 15.4394 4.90782C15.5017 5.00345 15.5567 5.11345 15.6667 5.33333C15.7216 5.44329 15.7491 5.49827 15.7803 5.54609C15.943 5.79559 16.2083 5.95961 16.5042 5.9935C16.561 6 16.6224 6 16.7454 6H17.8C18.9201 6 19.4802 6 19.908 6.21799C20.2843 6.40973 20.5903 6.71569 20.782 7.09202C21 7.51984 21 8.0799 21 9.2V16.8C21 17.9201 21 18.4802 20.782 18.908C20.5903 19.2843 20.2843 19.5903 19.908 19.782C19.4802 20 18.9201 20 17.8 20H6.2C5.0799 20 4.51984 20 4.09202 19.782C3.71569 19.5903 3.40973 19.2843 3.21799 18.908C3 18.4802 3 17.9201 3 16.8Z" })] }));
}
...
function OnOff(props) {
    ...
    return (jsxRuntime.jsx("button", { type: "button", "aria-label": label, "aria-pressed": scanning, disabled: buttonDisabled, onClick: toggleScanning, style: {
            ...buttonStyle$1,
            cursor: buttonDisabled ? 'default' : 'pointer',
        }, children: scanning ? (jsxRuntime.jsx(CameraOffIcon, { disabled: buttonDisabled })) : (jsxRuntime.jsx(CameraOnIcon, { disabled: buttonDisabled })) }));
}

function TorchOffIcon(props) {
    const { className, style } = props;
    return (jsxRuntime.jsx("svg", { "aria-hidden": "true", focusable: "false", width: "30px", height: "30px", viewBox: "0 0 24 24", className: className, style: style, xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { strokeWidth: 0.2, stroke: "yellow", fill: "yellow", d: "M14.516 15.158l.714.714-4.595 6.14-.75-.364L12.337 13H6.978L8.22 8.861l.803.803L8.322 12h3.036l1.793 1.792-1.475 5.16zm5.984 4.05L4.793 3.5l.707-.707 3.492 3.492L10.278 2h7.972l-5.025 7h7.149l-3.71 4.957 4.543 4.543zM12.707 10l3.243 3.243L18.376 10zM9.795 7.088l2.079 2.079L16.3 3h-5.278z" }) }));
}

function TorchOnIcon(props) {
    const { className, style } = props;
    return (jsxRuntime.jsx("svg", { "aria-hidden": "true", focusable: "false", width: "30px", height: "30px", viewBox: "0 0 24 24", className: className, style: style, xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { strokeWidth: 0.2, stroke: "yellow", fill: "yellow", d: "M13.225 9l5.025-7h-7.972l-3.3 11h5.359l-2.452 8.648.75.364L20.374 9zm.438 3H8.322l2.7-9H16.3l-5.025 7h7.101l-6.7 8.953z" }) }));
}
...
function Torch(props) {
    ...
    return (jsxRuntime.jsx("button", { type: "button", "aria-label": label, "aria-pressed": status, onClick: () => torchToggle(!status), style: buttonStyle, children: status ? jsxRuntime.jsx(TorchOffIcon, {}) : jsxRuntime.jsx(TorchOnIcon, {}) }));
}
...
function Zoom(props) {
    ...
    return (jsxRuntime.jsxs(react.Fragment, { children: [jsxRuntime.jsx("button", { type: "button", "aria-label": "Zoom out", disabled: atMin, onClick: handleZoomOut, style: {
                    ...zoomOutButtonStyle,
                    cursor: atMin ? 'default' : 'pointer',
                }, children: jsxRuntime.jsx(ZoomOutIcon, { disabled: atMin }) }), jsxRuntime.jsx("button", { type: "button", "aria-label": "Zoom in", disabled: atMax, onClick: handleZoomIn, style: {
                    ...zoomInButtonStyle,
                    cursor: atMax ? 'default' : 'pointer',
                }, children: jsxRuntime.jsx(ZoomInIcon, { disabled: atMax }) })] }));
}
...
function Finder(props) {
    ...
    return (jsxRuntime.jsx("div", { style: styles.fullContainer, children: jsxRuntime.jsxs("div", { style: styles.innerContainer, children: [jsxRuntime.jsx("div", { style: styles.overlay, children: jsxRuntime.jsxs("div", { style: styles.borderBox, children: [jsxRuntime.jsx("div", { style: styles.cornerTopLeft }), jsxRuntime.jsx("div", { style: styles.cornerTopRight }), jsxRuntime.jsx("div", { style: styles.cornerBottomLeft }), jsxRuntime.jsx("div", { style: styles.cornerBottomRight })] }) }), onOff && (jsxRuntime.jsx(OnOff, { scanning: scanning, startScanning: startScanning, stopScanning: stopScanning })), torch && capabilities.torch && (jsxRuntime.jsx(Torch, { scanning: scanning, status: torch.status, torchToggle: torch.toggle })), zoom && capabilities.zoom && (jsxRuntime.jsx(Zoom, { scanning: scanning, capabilities: capabilities.zoom, value: zoom.value, onZoom: zoom.onChange }))] }) }));
}
...
const Scanner = react.forwardRef(function Scanner(props, ref) {
    const { onScan, constraints, formats = ['any'], paused = false, components, tracker: trackerProp, children, styles, classNames, allowMultiple, scanDelay, retryDelay, onError, sound, startTimeoutMs, settleDelayMs, } = props;
    const videoRef = react.useRef(null);
    const pauseFrameRef = react.useRef(null);
    const trackingLayerRef = react.useRef(null);
    ...
    const mergedComponents = react.useMemo(() => ({ ...defaultComponents, ...components }), [components]);
    const effectiveTracker = trackerProp ?? mergedComponents.tracker;
    const [isMounted, setIsMounted] = react.useState(false);
    const [isCameraActive, setIsCameraActive] = react.useState(false);
    const [constraintsCached, setConstraintsCached] = react.useState(normalizedConstraints);
    const camera = useCamera({ startTimeoutMs, settleDelayMs });
    const cameraRef = react.useRef(camera);
    const onScanRef = react.useRef(onScan);
    const onErrorRef = react.useRef(onError);
    const trackerRef = react.useRef(effectiveTracker);
    react.useEffect(() => {
    ...
    const stableOnScan = react.useCallback((codes) => {
        onScanRef.current?.(codes);
    }, []);
    const stableOnError = react.useCallback((error) => {
        onErrorRef.current?.(error);
    }, []);
    const onFoundCallback = react.useCallback((detectedCodes) => {
        drawTracking(detectedCodes, videoRef.current, trackingLayerRef.current, trackerRef.current);
    }, []);
    const effectiveRetryDelay = retryDelay ?? (effectiveTracker === undefined ? 500 : 33);
    ...
    const onCameraChange = react.useCallback(async () => {
    ...
    const shouldScan = react.useMemo(() => {
    ...
    const containerStyle = react.useMemo(() => ({ ...defaultStyles.container, ...styles?.container }), [styles?.container]);
    const videoStyle = react.useMemo(() => ({
        ...defaultStyles.video,
        ...styles?.video,
        visibility: paused ? 'hidden' : 'visible',
    }), [styles?.video, paused]);
    const pauseFrameStyle = react.useMemo(() => ({
        ...pauseFrameStyleBase,
        display: paused ? 'block' : 'none',
    }), [paused]);
    return (jsxRuntime.jsxs("div", { style: containerStyle, className: classNames?.container, children: [jsxRuntime.jsx("video", { ref: videoRef, style: videoStyle, className: classNames?.video, autoPlay: true, muted: true, playsInline: true }), jsxRuntime.jsx("canvas", { ref: pauseFrameRef, style: pauseFrameStyle }), jsxRuntime.jsx("canvas", { ref: trackingLayerRef, style: trackingLayerStyle }), jsxRuntime.jsxs("div", { style: overlayStyle, children: [mergedComponents.finder && (jsxRuntime.jsx(Finder, { scanning: isCameraActive, capabilities: camera.capabilities, onOff: mergedComponents.onOff, zoom: mergedComponents.zoom && camera.settings.zoom
                            ? {
                            ...
                            : undefined, torch: mergedComponents.torch
                            ? {
                            ...
                            : undefined, startScanning: async () => await onCameraChange(), stopScanning: async () => {
                            try {
...
Object.defineProperty(exports, "prepareZXingModule", {
    enumerable: true,
    get: function () { return ponyfill.prepareZXingModule; }
});
Object.defineProperty(exports, "setZXingModuleOverrides", {
    enumerable: true,
    get: function () { return ponyfill.setZXingModuleOverrides; }
});
exports.Scanner = Scanner;
exports.boundingBox = boundingBox;
exports.centerText = centerText;
exports.createScannerError = createScannerError;
exports.isBarcodeDetectorSupported = isBarcodeDetectorSupported;
